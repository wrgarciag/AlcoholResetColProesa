...
#Filtrar solo codificado
total_2 <- total_2[Texto==0,]
...
# dt_agregado <- total_2[,list(Gasto=sum(GastoMes,na.rm = T),
#                       Cantidades=sum(LitrosMes,na.rm = T)),by=c("Canal","Item","Texto")]
# 
...
for(ii in canal){
  ...
  save.dta13(dt_precios_hogar,file = paste0(wdd_out,"UnitValuePrices_",ii,"_Codi.dta"))
  save.dta13(dt_consumo_hogar,file = paste0(wdd_out,"UnitValueGasto_",ii,"_Codi.dta"))
